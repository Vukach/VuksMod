...
public enum ModArmorMaterials implements ArmorMaterial {
    Plastic("plastic", 28, new int[]{1, 4, 5, 2}, 30, SoundEvents.ARMOR_EQUIP_CHAIN,
            2.0F, 0.0F, () -> Ingredient.of(ModItems.PLASTIC_HELMET.get()));
    ...
    public String getName() {
        return VukachMod.MOD_ID + ":" + this.name;
    }
